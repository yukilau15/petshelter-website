						...
						<div class="col-12">
							<div class="row justify-content-center align-items-center text-center">
								<div class="col-lg-6">
									...
									<p data-aos="fade-up" data-aos-delay="100"><a href="index.php" class="text-white">Home </a>&bullet; <a href="blog.php" class="text-white">Blog</span></p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="mb-5">
							...
							<div class="mb-4">
								<a href="blog_single.php?post=<?php echo $post_id; ?>">
									<img class="img-fluid rounded" src="postpics/<?php echo $post_image; ?>" alt="Image">
								</a>
							</div>
