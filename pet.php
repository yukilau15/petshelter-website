						...
						<div class="col-12">
							<div class="row justify-content-center align-items-center text-center">
								<div class="col-lg-6">
									...
									<p data-aos="fade-up" data-aos-delay="100"><a href="index.php" class="text-white">Home </a>&bullet; <a href="pet.php" class="text-white">Adopt A Pet</a></p>
								</div>
							</div>
						</div>
					</div>
								...
								if (mysqli_num_rows($run_query) > 0) {
									while ($row = mysqli_fetch_assoc($run_query)) {										
										...
										if ($post_status !== 'available') {
											echo "<h3><a href='#'>No Pets Yet</a></h3>";
										}
										else {
							?>
